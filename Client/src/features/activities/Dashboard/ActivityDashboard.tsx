  ...
  return (
      <Grid container  sx={{ marginTop: '20px', padding: '20px', width:'100%' }} spacing={{md:5}}>
        <Grid size={{ md: 8}} width={'100%'}>
         <ActivityList activities={props.activities}  handleActivitySelect={props.handleActivitySelect}/>
        </Grid>
        <Grid size={{md: 4}} width={'100%'}>
        {props.selectedActivity &&  <ActivityDetails activity={props.selectedActivity} handelCancelSelect={props.handelCancelSelect}/>}
        </Grid>
      </Grid>
  );
}
